...
import MenuTable from '@/user/components/group/restaurant/detail/MenuTable';
import { RestaurantDetailProps } from '@/user/type';
import { Box, Chip, Divider, IconButton, Typography, Stack } from '@mui/joy';
import ArrowBackIosNewIcon from '@mui/icons-material/ArrowBackIosNew';
import { useNavigate } from 'react-router-dom';
import { GROUP_PATH, RESTAURANT_END_POINT } from '@/common/constants';
