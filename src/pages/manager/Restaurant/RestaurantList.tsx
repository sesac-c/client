...
import RestaurantList from '@/components/manager/restaurant/list/RestaurantList';
import { navIcons } from '@/assets/icon';
import { useRestaurantManagement } from '@/hooks/manager/restaurant';
import ContentHeader from '@/components/manager/layout/ContentHeader';
import RestaurantRegisterModal from '@/components/manager/restaurant/register/RestaurantRegisterModal';
