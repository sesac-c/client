...
import { CourseRegisterFormProps, CourseRegisterModalProps, RegisterInstanceModalProps } from '../../../types';
...
import RegisterDateFormField from '../../common/UI/register/RegisterDateFormField';
