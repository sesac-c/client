...
const CampusRegisterForm: React.FC = () => {
...
const CampusRegisterModal: React.FC<RegisterInstanceModalProps> = ({ handleClick }) => {
  return (
    <RegisterModal
      registerButtonText='캠퍼스 등록'
      dialog={{
        title: '캠퍼스 등록'
      }}
      submit={{
        handleClick: handleClick,
        form: React.createElement(CampusRegisterForm)
      }}
    />
  );
};
