...
export enum CampusError {
  ...
  ERROR_NAME_INVALID = '캠퍼스명은 1자 이상 20자 이하로 입력 가능합니다.',
  ERROR_ADDRESS_REQUIRED = '주소를 입력해주세요.',
  ERROR_ADDRESS_INVALID = '주소는 1자 이상 150자 이하로 입력 가능합니다.'
}
...
export enum CourseError {
  ...
  ERROR_END_DATE_BEFORE_START_DATE = '종료일은 시작일 이후여야 합니다.'
}
...
export enum NoticeError {
  ...
  ERROR_COURSEID_REQUIRED = 'ERROR_COURSEID_REQUIRED'
}

export enum RunningmateError {
  ERROR_NAME_REQUIRED = 'ERROR_NAME_REQUIRED',
  ERROR_NAME_INVALID = 'ERROR_NAME_INVALID',
  ERROR_GOAL_REQUIRED = 'ERROR_GOAL_REQUIRED',
  ERROR_GOAL_INVALID = 'ERROR_GOAL_INVALID',
  ERROR_SUBJECT_REQUIRED = 'ERROR_SUBJECT_REQUIRED',
  ERROR_SUBJECT_INVALID = 'ERROR_SUBJECT_INVALID',
  ERROR_COURSEID_REQUIRED = 'ERROR_COURSEID_REQUIRED',
  ERROR_COURSEID_INVALID = '강의 아이디는 1 이상의 정수여야 합니다'
}
