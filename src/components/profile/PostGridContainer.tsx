...
import { ArchiveType, PostGridProps, UserPostResponse } from '@/types';
import { FEED_TYPE, POST_TYPE, ARCHIVE_TYPE, scrollStyle, THUMBNAIL_API_URL } from '@/constants';
import { getUserPosts, getUserLikePosts, getUserReplyPosts } from '@/services/api';

const DetailModal = lazy(() => import('@/components/feed/detail/DetailModal'));
