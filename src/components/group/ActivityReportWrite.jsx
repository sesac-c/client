...
import { Table, TableCell, TableContainer, TableHead, TableRow, Paper, Button, TextField, FormGroup, FormControlLabel, Checkbox} from '@mui/material';

import GroupName from '@/components/group/GroupName';
import ImageUploader from '@/components/group/image/ImageUploader';
...
export default ActivityReportWritePage;
