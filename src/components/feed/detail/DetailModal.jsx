...
import { ARCHIVE_TYPE, IMAGE_API_URL } from '@/constants';
import { PROFILE_PATH, USER_ARCHIVE_CHILDREN_PATH, USER_ARCHIVE_PATH } from '@/routes/paths';
              ...
              <div className='postdetail__side-container'>
                {feed.image !== null && (
                  <div className='postdetail__left-side'>
                    <Image image={IMAGE_API_URL(feed.image)} />
                  </div>
                )}
