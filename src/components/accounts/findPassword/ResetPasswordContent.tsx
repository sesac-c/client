...
import { ResetPasswordLayoutProps, ResetPasswordFormProps, ResetPasswordFieldsProps } from '@/types';
import Logo from '../../common/layout/Logo';
import { LOGIN_PATH } from '@/routes/paths';
import PasswordInput from '../signup/PasswordInput';
import { CONFIRMPASSWORD_FIELD_SETTING, PASSWORD_FIELD_SETTING } from '@/utils/form';
