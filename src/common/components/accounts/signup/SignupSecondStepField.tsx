...
import { CampusResponse, FormData, SignupSecondStepFieldProps } from '../../../types';
import axios from 'axios';
import { CourseResponse } from '@/manager/types';
import { getCampuses, getCourses } from '@/common/services/api/signup';
